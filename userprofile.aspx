                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col">
                                <center>
                                    ...
                                    <asp:Label ID="Label1" class="badge rounded-pill bg-info" runat="server" Text="Active"></asp:Label>
                                </center>
                            </div>
                        </div>
                        <div>
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <div class="form-group">
                                    <asp:TextBox CssClass="form-control" ID="TextBox5" runat="server" placeholder="Full Address" TextMode="MultiLine"
                                        Rows="2"></asp:TextBox>
                                </div>
                            </div>
